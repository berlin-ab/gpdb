...
void
test_DoTablespaceDeletion_calls_unlink_with_tablespace_oid_and_redo_flag(void **state) {
	setup();
...
main(int argc, char *argv[])
{
	...
	const UnitTest tests[] = {
		...
		unit_test(
			test_DoTablespaceDeletion_calls_unlink_with_tablespace_oid_and_redo_flag
			),
		unit_test(
